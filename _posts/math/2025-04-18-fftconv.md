...
date: 2025-04-18
author: 郑之杰
cover: 'https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-000.png'
tags: 数学
---
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-001.png)

卷积表征函数$\displaystyle f$与经过翻转和平移的$\displaystyle g$的乘积函数所围成的曲边梯形的面积。如果将参加卷积的一个函数看作区间的指示函数，卷积可以被看作是“移动平均”的推广。

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-002.gif)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-003.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-004.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-005.png)

结果表明，在做循环卷积的第一个和最后一个有效输出时，分别有上一周期和下一周期的序列参与了运算，导致了时域上的混叠。

若以周期$T=3$进行周期延拓（通过在序列结尾**padding**适当的$0$实现），则线性卷积和循环卷积的结果如下：

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-006.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-007.gif)

## （1）傅里叶变换的形式

傅里叶变换实现了时域函数$f(x)$与频域函数$\hat{f}(k)$之间的转换。其形式包括：

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-008.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-009.png)

上图中红框部分（即计算$A_1(W_{\frac{T}{2}}^k)$）又可以递归地计算为（相当于计算$A_1(W_{\frac{T}{4}}^k),A_2(W_{\frac{T}{4}}^k)$）：

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-010.png)

上图中红框部分（即计算$A_1(W_{\frac{T}{4}}^k)$满足递归的终止条件：

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-011.png)

该序列完整的**FFT**运算过程如下：

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-000.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-012.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-013.png)

有时需要打破卷积的因果性，比如希望实现类似于自注意力机制的全局上下文提取。一种简单的解决方式是对卷积核进行重复填充，保证在卷积运算时至少有$N$个位置使得输入序列的所有有效元素均参与运算。输出结果取这部分位置即可。

![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-014.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-015.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-016.png)
...
![](https://pub-c304ca0128b34bff97119b39961bc4f0.r2.dev/math-fftconv-017.png)