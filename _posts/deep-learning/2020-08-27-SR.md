...
5. 其他结构：如[<font color=blue>SRGAN</font>](https://0809zheng.github.io/2020/08/10/srresnet.html)引入生成对抗网络；[<font color=blue>LIIF</font>](https://0809zheng.github.io/2020/12/22/liif.html)学习二维图像的连续表达形式。
