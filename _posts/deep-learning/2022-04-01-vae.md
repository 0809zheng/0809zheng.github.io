...
也有一些方法针对**VAE**的模型结构进行改进，如[<font color=Blue>BN-VAE</font>](https://0809zheng.github.io/2022/04/18/bnvae.html)通过引入**BatchNorm**缓解**KL**散度消失问题(指较强的解码器允许训练时KL散度项$KL[q(z\|x)\|\|p(z)]=0$)。
