...
根据发射信号的工作频段不同，射频人体感知方法可以细分为基于毫米波雷达的方法、基于**WiFi**阵列的方法与基于穿墙雷达的方法。
- 基于毫米波雷达的方法：工作频段30-300GHZ，人体目标被视为散射体，可以捕获细粒度的人体细节，如
- 基于**WiFi**阵列的方法：工作频段2.4-5GHZ，人体目标被视为反射体，可以通过深度学习技术学习人体统计信息，如
...
### ⚪ [<font color=blue>radarSRNN</font>](https://0809zheng.github.io/2021/06/04/srcnn.html)
...
### ⚪ [<font color=blue>UWB-Pose</font>](https://0809zheng.github.io/2021/05/16/tlel.html)
